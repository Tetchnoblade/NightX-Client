...
class Arraylist(
    ...
    private val colorModeValue =
        ListValue("Color", arrayOf("Custom", "Random", "Sky", "CRainbow", "LiquidSlowly", "Fade", "Mixer"), "Custom")
    ...
    private val shadowColorBlueValue = IntegerValue(
        ...
        255,
        { shadowShaderValue.get() && shadowColorMode.get().equals("custom", true) })
    val colorRedValue = IntegerValue("Red", 240, 0, 255)
    val colorGreenValue = IntegerValue("Green", 240, 0, 255)
    val colorBlueValue = IntegerValue("Blue", 240, 0, 255)
        ...
        for (module in sortedModules) {
            ...
            if (module.array && (module.state || module.slide != 0F)) {
                ...
                when (hAnimation.get()) {
                    ...
                    "Slide" -> {
                        if (module.state) {
                            if (module.slide < width) {
                                module.slide = net.ccbluex.liquidbounce.utils.AnimationUtils.animate(
                                    width.toDouble(),
            ...
            if (module.array && module.slide > 0F) {
                ...
                when (vAnimation.get()) {
                    ...
                    "Slide", "Rise" -> module.arrayY = net.ccbluex.liquidbounce.utils.AnimationUtils.animate(
                        yPos.toDouble(),
