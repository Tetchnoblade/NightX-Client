...
object ToolDropdown {
    ...
    fun handleDraw(button: GuiButton) {
        ...
        Fonts.font35.drawString("Vanilla-Spoof", 4F, 7F, -1)
        Fonts.font35.drawString("FML-Spoof", 4F, 27F, if (AntiForge.enabled) -1 else gray)
        Fonts.font35.drawString("Proxy-Spoof", 4F, 47F, if (AntiForge.enabled) -1 else gray)
        Fonts.font35.drawString("Payloads-Spoof", 4F, 67F, if (AntiForge.enabled) -1 else gray)
        Fonts.font35.drawString("Bungee-Exploit", 4F, 87F, -1)
