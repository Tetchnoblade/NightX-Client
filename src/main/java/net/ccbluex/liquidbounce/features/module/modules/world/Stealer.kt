...
class Stealer : Module() {
    ...
    fun performStealer(screen: GuiScreen) {
        ...
        // inventory cleaner
        val inventoryCleaner = LiquidBounce.moduleManager[InventoryManager::class.java] as InventoryManager
        ...
        if (!isEmpty(screen) && !(closeOnFullValue.get() && fullInventory)) {
            ...
            if (silenceValue.get() && !stillDisplayValue.get()) LiquidBounce.hud.addNotification(
                Notification(
                    "Closed chest.",
