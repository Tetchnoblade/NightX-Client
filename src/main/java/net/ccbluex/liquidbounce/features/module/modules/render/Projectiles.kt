...
class Projectiles : Module() {
    ...
    fun onRender3D(event: Render3DEvent) {
        ...
        net.ccbluex.liquidbounce.utils.render.RenderUtils.enableGlCap(GL11.GL_BLEND, GL11.GL_LINE_SMOOTH)
        net.ccbluex.liquidbounce.utils.render.RenderUtils.disableGlCap(GL11.GL_DEPTH_TEST, GL11.GL_ALPHA_TEST, GL11.GL_TEXTURE_2D)
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA)
        GL11.glHint(GL11.GL_LINE_SMOOTH_HINT, GL11.GL_NICEST)
        net.ccbluex.liquidbounce.utils.render.RenderUtils.glColor(if (hitEntity) { java.awt.Color(255, 255, 255, 80) } else { java.awt.Color(255, 255, 255, 80) })
        GL11.glLineWidth(2f)
        ...
        if (landingPosition != null) {
            ...
            net.ccbluex.liquidbounce.utils.render.RenderUtils.drawAxisAlignedBB(AxisAlignedBB(-0.5, 0.0, -0.5, 0.5, 0.1, 0.5), if (hitEntity) { java.awt.Color(255, 255, 255, 80) } else { java.awt.Color(255, 255, 255, 80) })
        }
        GL11.glPopMatrix()
        GL11.glDepthMask(true)
        net.ccbluex.liquidbounce.utils.render.RenderUtils.resetCaps()
