...
public final class TwoDTags extends Module {
    ...
    public static boolean shouldCancelNameTag(EntityLivingBase entity) {
        return LiquidBounce.moduleManager.getModule(TwoDTags.class) != null && LiquidBounce.moduleManager.getModule(TwoDTags.class).getState() && LiquidBounce.moduleManager.getModule(TwoDTags.class).tagsValue.get() && collectedEntities.contains(entity);
    }
