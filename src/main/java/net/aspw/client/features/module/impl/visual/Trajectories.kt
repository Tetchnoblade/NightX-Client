...
@ModuleInfo(name = "Trajectories", category = ModuleCategory.VISUAL, array = false)
class Trajectories : Module() {
    ...
    fun onRender3D(event: Render3DEvent) {
        ...
        net.aspw.client.utils.render.RenderUtils.enableGlCap(GL11.GL_BLEND, GL11.GL_LINE_SMOOTH)
        net.aspw.client.utils.render.RenderUtils.disableGlCap(
            GL11.GL_DEPTH_TEST,
            GL11.GL_ALPHA_TEST,
            GL11.GL_TEXTURE_2D
        )
        ...
        net.aspw.client.utils.render.RenderUtils.glColor(
            if (hitEntity) {
        ...
        if (landingPosition != null) {
            ...
            net.aspw.client.utils.render.RenderUtils.drawAxisAlignedBB(
        ...
        net.aspw.client.utils.render.RenderUtils.resetCaps()
