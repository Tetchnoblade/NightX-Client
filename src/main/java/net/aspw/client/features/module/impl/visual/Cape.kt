...
class Cape : Module() {
    ...
    enum class CapeStyle(val location: ResourceLocation) {
        ...
        RISE5LIGHT(ResourceLocation("client/cape/rise5light.png")),
        RISE5DARK(ResourceLocation("client/cape/rise5dark.png")),
