package net.aspw.client.features.module.modules.player;
...
public class Scaffold extends Module {
    ...
    public final ListValue rotationModeValue = new ListValue("RotationMode", new String[]{"Normal", "AAC", "Watchdog", "Static", "Static2", "Static3", "Spin", "Custom"}, "Normal");
            ...
            case "packet":
                if (mc.thePlayer.onGround && timer.hasTimePassed(2)) {
                    ...
                    mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX,
                            mc.thePlayer.posY + 0.41999998688698D, mc.thePlayer.posZ, false));
                    mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX,
    ...
    public void onUpdate(final UpdateEvent event) {
        ...
        if (shouldGoDown) {
            ...
            if ((!autoJumpValue.get() && !(smartSpeedValue.get() && Client.moduleManager.getModule(Speed.class).getState())) || GameSettings.isKeyDown(mc.gameSettings.keyBindJump) || mc.thePlayer.posY < launchY)
                launchY = (int) mc.thePlayer.posY;
            if (autoJumpValue.get() && !Client.moduleManager.getModule(Speed.class).getState() && MovementUtils.isMoving() && mc.thePlayer.onGround) {
                mc.thePlayer.jump();
            }
        }
    }
    ...
    public void onMotion(final MotionEvent event) {
        ...
        if (rotationsValue.get() && keepRotationValue.get() && lockRotation != null) {
            ...
            RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw - 180, 84));
            if (!mc.gameSettings.keyBindForward.isKeyDown() && !mc.gameSettings.keyBindRight.isKeyDown() && !mc.gameSettings.keyBindLeft.isKeyDown() && mc.gameSettings.keyBindBack.isKeyDown()) {
                RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw, 84));
            }
            if (mc.gameSettings.keyBindForward.isKeyDown() && mc.gameSettings.keyBindRight.isKeyDown() && !mc.gameSettings.keyBindLeft.isKeyDown() && !mc.gameSettings.keyBindBack.isKeyDown()) {
                RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw - 135, 84));
            }
            if (!mc.gameSettings.keyBindForward.isKeyDown() && mc.gameSettings.keyBindRight.isKeyDown() && !mc.gameSettings.keyBindLeft.isKeyDown() && !mc.gameSettings.keyBindBack.isKeyDown()) {
                RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw - 90, 84));
            }
            if (!mc.gameSettings.keyBindForward.isKeyDown() && mc.gameSettings.keyBindRight.isKeyDown() && !mc.gameSettings.keyBindLeft.isKeyDown() && mc.gameSettings.keyBindBack.isKeyDown()) {
                RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw - 45, 84));
            }
            if (mc.gameSettings.keyBindForward.isKeyDown() && !mc.gameSettings.keyBindRight.isKeyDown() && mc.gameSettings.keyBindLeft.isKeyDown() && !mc.gameSettings.keyBindBack.isKeyDown()) {
                RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw - 225, 84));
            }
            if (!mc.gameSettings.keyBindForward.isKeyDown() && !mc.gameSettings.keyBindRight.isKeyDown() && mc.gameSettings.keyBindLeft.isKeyDown() && !mc.gameSettings.keyBindBack.isKeyDown()) {
                RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw - 270, 84));
            }
            if (!mc.gameSettings.keyBindForward.isKeyDown() && !mc.gameSettings.keyBindRight.isKeyDown() && mc.gameSettings.keyBindLeft.isKeyDown() && mc.gameSettings.keyBindBack.isKeyDown()) {
                RotationUtils.setTargetRotation(new Rotation(mc.thePlayer.rotationYaw - 315, 84));
            }
        }
    ...
    private void place(boolean towerActive) {
        ...
        if (!towerActivation() && (!delayTimer.hasTimePassed(delay) || ((sameYValue.get() || ((autoJumpValue.get() || (smartSpeedValue.get() && Client.moduleManager.getModule(Speed.class).getState())) && !GameSettings.isKeyDown(mc.gameSettings.keyBindJump))) && launchY - 1 != (int) (towerActive ? towerPlace : targetPlace).getVec3().yCoord)))
            return;
    ...
    public void onRender2D(final Render2DEvent event) {
        ...
        if (counterMode.equalsIgnoreCase("dark")) {
            Fonts.minecraftFont.drawString(getBlocksAmount() + "", scaledResolution.getScaledWidth() / 2 - (infoWidth2 / 2) - 1, scaledResolution.getScaledHeight() / 2 - 36, 0xff000000, false);
            Fonts.minecraftFont.drawString(getBlocksAmount() + "", scaledResolution.getScaledWidth() / 2 - (infoWidth2 / 2) + 1, scaledResolution.getScaledHeight() / 2 - 36, 0xff000000, false);
            Fonts.minecraftFont.drawString(getBlocksAmount() + "", scaledResolution.getScaledWidth() / 2 - (infoWidth2 / 2), scaledResolution.getScaledHeight() / 2 - 35, 0xff000000, false);
            Fonts.minecraftFont.drawString(getBlocksAmount() + "", scaledResolution.getScaledWidth() / 2 - (infoWidth2 / 2), scaledResolution.getScaledHeight() / 2 - 37, 0xff000000, false);
            Fonts.minecraftFont.drawString(getBlocksAmount() + "", scaledResolution.getScaledWidth() / 2 - (infoWidth2 / 2), scaledResolution.getScaledHeight() / 2 - 36, 0xffff00ff, false);
        }
    }
        ...
        for (int i = 0; i < ((modeValue.get().equalsIgnoreCase("Expand") && !towerActivation()) ? expandLengthValue.get() + 1 : 2); i++) {
            final BlockPos blockPos = new BlockPos(
                    ...
                    (!towerActivation()
                            && (sameYValue.get() ||
                            ((autoJumpValue.get() ||
                                    (smartSpeedValue.get() && Client.moduleManager.getModule(Speed.class).getState()))
