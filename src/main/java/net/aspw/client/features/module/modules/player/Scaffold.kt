...
import net.aspw.client.utils.VecRotation.PlaceRotation
...
class Scaffold : Module() {
    ...
    val speedModifierValue = FloatValue("SpeedModifier", 1f, 0f, 2f, "x")
    val xzMultiplier = FloatValue("XZ-Multiplier", 1f, 0f, 4f, "x")
