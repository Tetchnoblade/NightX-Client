...
public class AACPort extends SpeedMode {
    ...
    public void onUpdate() {
        ...
        final float f = RotationUtils.cameraYaw * 0.017453292F;
        for (double d = 0.2; d <= Objects.requireNonNull(Launch.moduleManager.getModule(Speed.class)).portMax.get(); d += 0.2) {
