package net.aspw.client.features.command.special
...
class XrayCommand : Command("xray", emptyArray()) {
    ...
    val xRay = Client.moduleManager.getModule(XRay::class.java) as XRay
            ...
            if (args[1].equals("add", ignoreCase = true)) {
                if (args.size > 2) {
                    try {
                        ...
                        Client.fileManager.saveConfig(Client.fileManager.xrayConfig)
