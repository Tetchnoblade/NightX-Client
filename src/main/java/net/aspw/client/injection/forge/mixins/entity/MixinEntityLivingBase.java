...
public abstract class MixinEntityLivingBase extends MixinEntity {
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            ...
            if (killAura.getMovementFix().get().equals("Full") && killAura.getState() && killAura.getTarget() != null) {
                jumpEvent.setYaw(Objects.requireNonNull(RotationUtils.serverRotation).getYaw());
