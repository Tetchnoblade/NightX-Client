...
object Launch {
    ...
    private val onlyInt = regex.find(javaVersion)?.value ?: ""
    private val result = onlyInt.substring(onlyInt.length - 3).toInt()
    var useAltManager = result >= 181 && MinecraftInstance.mc.isJava64bit
