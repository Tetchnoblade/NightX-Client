package net.aspw.nightx.config;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import net.aspw.nightx.NightX;
import net.aspw.nightx.config.configs.*;
...
public class FileManager extends MinecraftInstance {
    ...
    public final File oldDir = new File(mc.mcDataDir, NightX.CLIENT_FOLDER + "");
    public File dir = new File(mc.mcDataDir, NightX.CLIENT_FOLDER);
    ...
    private void saveConfig(final FileConfig config, final boolean ignoreStarting) {
        if (!ignoreStarting && NightX.INSTANCE.isStarting())
            return;
