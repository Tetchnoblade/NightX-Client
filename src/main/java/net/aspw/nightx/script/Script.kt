package net.aspw.nightx.script
...
import net.aspw.nightx.script.api.*
import net.aspw.nightx.script.api.global.Chat
import net.aspw.nightx.script.api.global.Item
import net.aspw.nightx.script.api.global.Setting
...
class Script(val scriptFile: File) {
    ...
    init {
        ...
        scriptEngine.put("moduleManager", NightX.moduleManager)
        scriptEngine.put("commandManager", NightX.commandManager)
        scriptEngine.put("scriptManager", NightX.scriptManager)
    ...
    fun registerModule(moduleObject: JSObject, callback: JSObject) {
        ...
        NightX.moduleManager.registerModule(module)
    ...
    fun registerCommand(commandObject: JSObject, callback: JSObject) {
        ...
        NightX.commandManager.registerCommand(command)
    ...
    fun onDisable() {
        ...
        registeredModules.forEach { NightX.moduleManager.unregisterModule(it) }
        registeredCommands.forEach { NightX.commandManager.unregisterCommand(it) }
    ...
    fun import(scriptFile: String) {
        scriptEngine.eval(File(NightX.scriptManager.scriptsFolder, scriptFile).readText())
    }
