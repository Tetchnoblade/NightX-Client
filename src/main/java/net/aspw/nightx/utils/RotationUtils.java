...
import net.aspw.nightx.event.TickEvent;
import net.aspw.nightx.features.module.modules.combat.FastBow;
...
public final class RotationUtils extends MinecraftInstance implements Listenable {
    ...
    public static void faceBow(final Entity target, final boolean silent, final boolean predict, final float predictSize) {
        ...
        float velocity = NightX.moduleManager.getModule(FastBow.class).getState() ? 1F : player.getItemInUseDuration() / 20F;
