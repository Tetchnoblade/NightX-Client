...
import net.aspw.nightx.features.module.modules.combat.TPAura
...
import net.aspw.nightx.visual.hud.element.elements.targets.impl.*
...
class Target(
    ...
    override fun drawElement(): Border? {
        ...
        val kaTarget = (NightX.moduleManager[KillAura::class.java] as KillAura).target
        val taTarget = (NightX.moduleManager[TPAura::class.java] as TPAura).lastTarget
