...
class ModItems : CreativeTabs("Mod Items") {
    override fun displayAllReleventItems(itemList: MutableList<ItemStack>) {
        ...
        itemList.add(ItemUtils.createItem("chest 64 0 {BlockEntityTag:{Items:[],id:\"minecraft:chest\",Lock:\"鍵\",},}"))
        itemList.add(ItemUtils.createItem("trapped_chest 64 0 {BlockEntityTag:{Items:[],id:\"minecraft:chest\",Lock:\"鍵\",},}"))
        itemList.add(ItemUtils.createItem("furnace 64 0 {BlockEntityTag:{Items:[],id:\"minecraft:furnace\",Lock:\"鍵\",},}"))
        itemList.add(ItemUtils.createItem("dispenser 64 0 {BlockEntityTag:{Items:[],id:\"minecraft:dispenser\",Lock:\"鍵\",},}"))
        itemList.add(ItemUtils.createItem("dropper 64 0 {BlockEntityTag:{Items:[],id:\"minecraft:dropper\",Lock:\"鍵\",},}"))
        itemList.add(ItemUtils.createItem("hopper 64 0 {BlockEntityTag:{Items:[],id:\"minecraft:hopper\",Lock:\"鍵\",},}"))
