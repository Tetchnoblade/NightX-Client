...
class Stealer : Module() {
    ...
    fun performStealer(screen: GuiScreen) {
        ...
        // inventory cleaner
        val inventoryCleaner = NightX.moduleManager[InventoryManager::class.java] as InventoryManager
        ...
        if (!isEmpty(screen) && !(closeOnFullValue.get() && fullInventory)) {
            ...
            if (silenceValue.get() && !stillDisplayValue.get()) NightX.hud.addNotification(
                Notification(
                    "Closed chest.",
