...
import net.aspw.nightx.injection.implementations.IItemStack;
import net.aspw.nightx.utils.InventoryUtils;
import net.aspw.nightx.utils.MovementUtils;
import net.aspw.nightx.utils.item.ArmorComparator;
...
public class AutoArmor extends Module {
    ...
    private final BoolValue simulateInventory = new BoolValue("SimulateInventory", false);    private final IntegerValue maxDelayValue = new IntegerValue("MaxDelay", 14, 0, 1000) {
        @Override
    ...
    public void onRender3D(final Render3DEvent event) {
        ...
        // Find best armor
        final Map<Integer, java.util.List<ArmorPiece>> armorPieces = IntStream.range(0, 36)
                .filter(i -> {
