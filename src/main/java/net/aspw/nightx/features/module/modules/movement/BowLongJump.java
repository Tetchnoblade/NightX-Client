...
public class BowLongJump extends Module {
    ...
    private final FloatValue heightValue = new FloatValue("Height", 0.58F, 0F, 10F, "m");
        ...
        switch (bowState) {
            case 0:
                ...
                if (slot < 0 || !mc.thePlayer.inventory.hasItem(Items.arrow)) {
                    NightX.hud.addNotification(new Notification("No arrows or bow found in your inventory!", Notification.Type.ERROR));
                    forceDisable = true;
                    bowState = 5;
    ...
    public void onRender2D(final Render2DEvent event) {
        ...
        Fonts.fontSFUI40.drawCenteredString(getBowStatus(), scaledRes.getScaledWidth() / 2F, scaledRes.getScaledHeight() / 2F + 14F, -1, true);
