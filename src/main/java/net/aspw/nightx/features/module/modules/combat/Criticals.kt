...
class Criticals : Module() {
    ...
    fun onAttack(event: AttackEvent) {
        if (onlyAuraValue.get() && !NightX.moduleManager[KillAura::class.java]!!.state && !NightX.moduleManager[TPAura::class.java]!!.state) return
        ...
        if (event.targetEntity is EntityLivingBase) {
            ...
            if (!mc.thePlayer.onGround || mc.thePlayer.isOnLadder || mc.thePlayer.isInWeb || mc.thePlayer.isInWater ||
                ...
                NightX.moduleManager[Flight::class.java]!!.state || !msTimer.hasTimePassed(
    ...
    fun onPacket(event: PacketEvent) {
        if (onlyAuraValue.get() && !NightX.moduleManager[KillAura::class.java]!!.state) return
