...
import net.aspw.nightx.utils.render.RenderUtils.drawTriAngle
import net.aspw.nightx.utils.render.RenderUtils.isInViewFrustrum
...
@ModuleInfo(name = "PointerESP", spacedName = "Pointer ESP", category = ModuleCategory.RENDER, array = false)
