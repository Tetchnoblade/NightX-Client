...
import net.aspw.nightx.utils.render.Render
...
@ModuleInfo(name = "JumpCircle", spacedName = "Jump Circle", category = ModuleCategory.RENDER)
class JumpCircle : Module() {
    ...
    class Circle(val time: Long, val x: Double, val y: Double, val z: Double) {
        ...
        val jumpModule = NightX.moduleManager.getModule(JumpCircle::class.java) as JumpCircle
