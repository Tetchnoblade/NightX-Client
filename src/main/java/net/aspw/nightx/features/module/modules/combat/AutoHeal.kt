...
class AutoHeal : Module() {
    ...
    override fun onInitialize() {
        killAura = NightX.moduleManager.getModule(KillAura::class.java)!!
        scaffold = NightX.moduleManager.getModule(Scaffold::class.java)!!
    }
    ...
    private fun debug(s: String) {
        if (debugValue.get())
            ClientUtils.displayChatMessage(NightX.CLIENT_CHAT + "§3$s")
    }
