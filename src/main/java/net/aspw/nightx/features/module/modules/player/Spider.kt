...
import net.aspw.nightx.utils.block.BlockUtils.collideBlockIntersects
...
class Spider : Module() {
    private val modeValue =
        ListValue("Mode", arrayOf("Simple", "Jump", "CheckerClimb", "Clip", "AAC3.3.12", "AACGlide", "Verus"), "Simple")
