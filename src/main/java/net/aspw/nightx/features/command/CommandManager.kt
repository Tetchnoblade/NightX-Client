...
import net.aspw.nightx.features.command.commands.*
import net.aspw.nightx.features.command.shortcuts.Shortcut
import net.aspw.nightx.features.command.shortcuts.ShortcutParser
import net.aspw.nightx.features.command.special.XrayCommand
...
class CommandManager {
    ...
    fun registerShortcut(name: String, script: String) {
        if (getCommand(name) == null) {
            ...
            NightX.fileManager.saveConfig(NightX.fileManager.shortcutsConfig)
        } else {
