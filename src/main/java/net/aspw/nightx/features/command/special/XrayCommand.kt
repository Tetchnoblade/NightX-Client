package net.aspw.nightx.features.command.special
...
class XrayCommand : Command("xray", emptyArray()) {
    ...
    val xRay = NightX.moduleManager.getModule(XRay::class.java) as XRay
            ...
            if (args[1].equals("add", ignoreCase = true)) {
                if (args.size > 2) {
                    try {
                        ...
                        NightX.fileManager.saveConfig(NightX.fileManager.xrayConfig)
