package net.aspw.nightx.ui.client.clickgui.newVer.element.module.value.impl

import net.aspw.nightx.ui.client.clickgui.newVer.ColorManager
import net.aspw.nightx.ui.client.clickgui.newVer.element.components.Slider
...
class FloatElement(val savedValue: FloatValue) : ValueElement<Float>(savedValue) {
    ...
    override fun drawElement(
        ...
        val valueDisplay =
            30F + Fonts.fontSFUI40.getStringWidth("${savedValue.maximum.toInt().toFloat() + 0.01F}${savedValue.suffix}")
        ...
        val currLength = Fonts.fontSFUI40.getStringWidth("${round(savedValue.get())}${savedValue.suffix}")
