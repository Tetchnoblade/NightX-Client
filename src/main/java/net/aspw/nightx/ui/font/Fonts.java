...
public class Fonts {
    ...
    public static void loadFonts() {
        ...
        try {
            ...
            final File fontsFile = new File(NightX.fileManager.fontsDir, "fonts.json");
    ...
    private static void downloadFonts() {
        try {
            final File outputFile = new File(NightX.fileManager.fontsDir, "roboto.zip");
            final File sfuiFile = new File(NightX.fileManager.fontsDir, "sfui.ttf");
            final File jelloFile = new File(NightX.fileManager.fontsDir, "jelloregular.ttf");
            final File prodSansFile = new File(NightX.fileManager.fontsDir, "Roboto-Medium.ttf");
            final File prodBoldFile = new File(NightX.fileManager.fontsDir, "Roboto-Bold.ttf");
            final File tahomaFile = new File(NightX.fileManager.fontsDir, "TahomaBold.ttf");
            final File tahomaReFile = new File(NightX.fileManager.fontsDir, "Tahoma.ttf");
            final File bangersFile = new File(NightX.fileManager.fontsDir, "Bangers-Regular.ttf");
    ...
    private static Font getFont(final String fontName, final int size) {
        try {
            final InputStream inputStream = new FileInputStream(new File(NightX.fileManager.fontsDir, fontName));
